...
- `npm run ci:check-admin-consistency` - verify admin pages/nav contracts (layout/header parity, nav-to-route mapping, hydrated page `<noscript>` fallbacks, comments gate).
