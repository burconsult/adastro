...
### Changed
- Bypassed locale redirects for internal Vercel paths, stopped generating unsupported `/_vercel/image` optimizer URLs on Astro/Vercel deployments, and added a guarded compatibility redirect for stale local image optimizer URLs.
