...
-- Insert sample posts
INSERT INTO posts (id, title, slug, content, excerpt, author_id, featured_image_id, status, published_at, seo_metadata) VALUES
  (
...
INSERT INTO page_sections (id, page_id, type, content, order_index) VALUES
  ...
  (
    ...
    (SELECT id FROM pages WHERE slug = 'blog'),
    'hero',
...
JOIN posts p ON p.slug = links.post_slug
