...
-- Scheduled publishing queue + worker
...
-- Editorial audit trail. Audit events are separate from operational system
-- logs and remain immutable except for explicit service-role retention pruning.
